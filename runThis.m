...
%% Clear Everything
clc; clear; close all;
fprintf('Here are tabulated results:\n')
fprintf('--------------------------\n')

%% Initial Declarations
% Define all constants
N = 250;  % Number of panels in Vortex Panel Method
...
%% Problem #3 - Determine cl vs alpha for a number of airfoils
fprintf('\n')
problem3(true,N,Vinf,m,p,t,c); % Call function for Problem 3
% This function takes care of all calculations by calling plotCLvsAlpha.
% This function returns results to be plotted
